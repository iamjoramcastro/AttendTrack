...
var FIREBASE_SKIP=[
  'firebaseio.com','googleapis.com','securetoken.googleapis.com',
  'identitytoolkit.googleapis.com','firebase.google.com','firebaseapp.com'
];

function skipCache(url){
  return FIREBASE_SKIP.some(function(d){return url.hostname.includes(d);});
}
